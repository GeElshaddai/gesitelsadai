    ...
    <section id="home" className={styles.home}>
      <Container>
        <FadeContent>
          ...
          <Row>
            <Col lg="4">
              <h1 className={styles.jobTitle}>Ship Engineer</h1>
            </Col>
            <Col lg="8">
              Enthusisatic about{" "}
              <span style={{ color: "aqua" }}>leveraging</span> my diverse skill
              set and experiences. Focus on innovation and reliability to create
              solutions that enhance vessel{" "}
